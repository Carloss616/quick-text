...
const APFEL_VIEWS: Record<ModelErrorState, ErrorView> = {
  [ModelErrorState.NotRunning]: {
    ...
    markdown: [
      ...
      "",
      "apfel is installed but the server on `localhost:11434` didn't answer as apfel.",
      "",
      "### What to do",
      "",
      ...
      "```",
      "",
      "> apfel and Ollama share port 11434. If **Ollama** is running, stop it",
      "> (`ollama stop` / quit the app) or switch the provider back to Ollama —",
      "> only one can own that port.",
    ].join("\n"),
  },
  [ModelErrorState.Missing]: {
    icon: Icon.ExclamationMark,
    title: "Apfel is not installed",
    subtitle: "Install apfel via Homebrew",
    markdown: [
      "### apfel isn't installed",
      "",
      "The **Install & Start Apfel** action will:",
      "",
      "1. Install apfel with Homebrew.",
